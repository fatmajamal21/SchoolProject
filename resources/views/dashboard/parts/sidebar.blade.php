...
<ul class="metismenu" id="menu">
    ...
    <li>
      ...
      <ul>
        <li> <a href="{{route('dash.grade.index')}}"><i class="bi bi-chalkboard"></i>جميع المستويات </a>
        </li>
        <li> <a href="{{route('dash.grade.create')}}"><i class="bi bi-circle"></i>إضافة مستوى جديد</a>
        </li>
      </ul>
    </li>
    <li>
